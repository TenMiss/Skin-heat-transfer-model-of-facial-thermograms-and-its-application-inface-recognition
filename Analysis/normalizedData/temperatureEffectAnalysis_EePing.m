...
data=load('J:\A40\dataBase\EePing.mat');
%data=load('J:\A40\dataBase\XingRong.mat');
fld=fieldnames(data);
...
data=load('J:\A40\testData\level5outside\test602.mat');
%data=load('J:\A40\testData\level5outside\test688.mat');
fld=fieldnames(data);
I=getfield(data,fld{1});
if (~isa(I,'double'))
    I=double(I);
